import { Scene, Physics, GameObjects, Geom } from "phaser";
...
export class GameScene extends Scene {
    ...
    private onClick(star: Physics.Arcade.Image): () => void {
        return function () {
    ...
    private onFall(star: Physics.Arcade.Image): () => void {
        return function () {
